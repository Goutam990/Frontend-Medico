...
export default function Bookings() {
  ...
  const handleUpdateStatus = async (booking: Booking, status: 'Approved' | 'Rejected' | 'Done') => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          ...
          text: `The booking has been marked as ${actionText}.`,
          timer: 2000,
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900">{new Date(selectedBooking.appointmentDate).toLocaleDateString()}</p>
                </div>
                <div>
            ...
            <div className="p-6 border-t flex justify-end">
              <button onClick={() => setShowDetailsModal(false)} className="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                Close
              </button>
            </div>
          </div>
